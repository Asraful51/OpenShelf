...
<div style="background-color: #fef2f2; border: 1px solid #fecaca; border-radius: 16px; padding: 25px; text-align: center; margin: 30px 0;">
    ...
    <div style="font-size: 48px; font-weight: 900; color: #ef4444; margin: 10px 0;">{{ $overdue_days ?? '0' }} Days</div>
...
<div style="text-align: center; margin-top: 30px;">
    ...
    <a href="https://wa.me/88{{ preg_replace('/[^0-9]/', '', $owner_phone) }}" style="display: inline-block; padding: 14px 35px; background-color: #25D366; color: #ffffff !important; text-decoration: none; border-radius: 12px; font-weight: 600; margin-bottom: 10px;">Contact via WhatsApp</a><br>
    @endif
