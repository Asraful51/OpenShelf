...
@section('content')
@php
    $finalLoginUrl = $login_url ?? ($base_url . '/login');
@endphp
<div class="greeting">Welcome to the family, {{ $user_name ?? 'Reader' }}! 👋</div>
...
<div style="text-align: center; margin-top: 30px;">
    <a href="{{ $finalLoginUrl }}" class="button">Go to Dashboard</a>
</div>
@endsection
